...
const ZakatTanaman = (props) => {
  ...
  const openInfo = () => {
    f7.dialog
      .create({
        title: "Nishab Zakat Tanaman Produktif",
        text: `Karena zakat tanaman produktif merupakan kelompok zakat tijarah, maka standar nishab zakat adalah senilai nishab emas yaitu 20 Dinar (setara dengan 77,5 gram menurut mazhab Syafi'i, Maliki, dan Hanbali).
  ...
  return (
    <div className="h-full">
      ...
      <div className="  bg-white border-b-8 border-gray-100 p-4 ">
        ...
        <div className="mx-4">
          <div className="mt-4 mb-2">Biaya Bibit</div>
      ...
      <div className="mt-3 mb-24 w-full px-4">
        ...
        <div className="mx-4">
          <p>
            (Biaya Bibit + Simpanan + Piutang Dagang - Utang Tertanggung) x 2,5%
          </p>
        </div>
      </div>
