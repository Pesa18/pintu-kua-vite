  ...
  const openInfo = () => {
    f7.dialog
      .create({
        ...
        text: `Karena zakat perdagangan merupakan kelompok zakat tijarah, maka standar nishab zakat adalah senilai nishab emas yaitu 20 Dinar (setara dengan 77,5 gram menurut mazhab Syafi'i, Maliki, dan Hanbali).
Harga emas senilai Rp. ${metalprices.emas}/gr (pertanggal ${moment().format(
          " dddd DD MMMM YYYY"
        )}).`,
        buttons: [
          {
  ...
  useEffect(() => {
    if (metalprices) {
      setMetalprice(
        parseFloat(parseFloat(metalprices.emas) * parseFloat(nihsab.gram))
      );
    }

    hitungZakat();
  }, [modal, simpanan, piutang, utang, metalprices]);
  const hapusHitungan = () => {
    setWajibZakat(0);
    setModal("");
    setPiutang("");
    ...
    <div className="h-full">
      ...
      <div className="  bg-white border-b-8 border-gray-100 p-4 ">
        ...
        <div className="mx-4">
          ...
          <div className="mt-4 mb-2">Simpanan (Nuqud)</div>
          <div className="w-full  rounded-lg ring-primary ring-1 relative bg-slate-100">
            <NumericFormat
              //   getInputRef={targetValue}
              value={simpanan}
          ...
          <div className="mt-4 mb-2">
            Utang Tertanggung (Dain al-tajr li al-Tijarah)
          </div>
          <div className="w-full  rounded-lg ring-primary ring-1 relative bg-slate-100">
            <NumericFormat
              //   getInputRef={targetValue}
      ...
      <div className="mt-3 mb-24 w-full px-4">
        ...
        <div className="mx-4">
          <p>(Modal + Laba + Piutang Dagang - Utang Modal) x 2,5%</p>
          <p>
            <span>Catatn :</span> <br />
            <p>
              Penting Untuk dicatat bahwa segala penambahan biaya yang dapat
              menyebabkan bertambahnya jumlah atau kuantitas barang dagangan,
              maka biaya tersebut dihitung sebagai modal.
            </p>
          </p>
          <p>
            Apabila cara toko tersebut dalam menambah barang dagangannya adalah
            dengan sistem “bawa-laku-bayar”, maka besaran utang yang harus
            dilunasi oleh pemilik toko kepada toko tempatnya kulak, dihitung
            sebagai 2, yaitu: (1) sebagai modal, dan (2) sebagai utang.
          </p>

          <p>
            Maksud dari sistem ‘bawa-laku-bayar’, adalah pihak toko membawa
            barang dulu dari tempat kulak, kemudian dijual, setelah laku baru
            dibayar.
          </p>

          <p>
            Uang kas yang diambil untuk kebutuhan konsumtif, tidak menjadi
            bagian yang dihitung sebagai zakat.
          </p>
        </div>
      </div>
